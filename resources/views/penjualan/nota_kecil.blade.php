...
<body onload="window.print()">
    ...
    <div>
        <table width="100%" style="border: 0;">
            ...
            <tr>
                <td>Tipe Bayar</td>
                <td class="text-right">{{ $penjualan->tipe_bayar }}</td>
            </tr>
            <tr>
                <td>Tipe Transaksi</td>
                <td class="text-right">{{ $penjualan->tipe_transaksi }}</td>
            </tr>
        </table>

        @if ($penjualan->tipe_bayar == 'Non Tunai')
            <div class="text-center" style="margin-top: 10px">
                <div class="">
                    <img src="{{ asset('qris/qrisTitle.png') }}" style="width: 65%">
                </div>
                <div class="">
                    <img src="{{ asset('qris/qrisImage.png') }}" style="width: 65%">
                </div>
            </div>
        @endif
    </div>
