          ...
          <div class="d-flex align-items-end row">
            <div class="col-sm-7">
              <div class="card-body">
                ...
                <p class="mb-4">
                  Kamu Punya <span class="fw-bold">{{ $promo }}</span> Promo Yang Sedang Berlangsung. <br>
                </p>
                <a href="{{ route ('promo.index') }}" class="btn btn-sm btn-outline-primary">Lihat Disini</a>
              </div>
            </div>
                ...
                <div class="card-title d-flex align-items-start justify-content-between">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                      <a class="dropdown-item" href="{{ route ('kategori.index') }}">View More</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-title d-flex align-items-start justify-content-between">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                      <a class="dropdown-item" href="{{ route ('produk.index') }}">View More</a>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <span class="fw-semibold d-block mb-1">Produk</span>
                <h3 class="card-title mb-2">{{ $produk }} Pcs </h3>
              </div>
            </div>
          </div>
        </div>
